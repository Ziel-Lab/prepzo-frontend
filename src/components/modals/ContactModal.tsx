"use client";
import { closeContactModal } from "@/utils/toggleContactModal";
              ...
              <div className="panel w-100 sm:w-350px md:w-500px mx-auto">
                ...
                >
                  ...
                  <p className="fs-7 opacity-70 mt-2 text-center">
                    We’ll tailor your demo to your immediate needs and answer all
                    your questions. Get ready to see how it works!
                  </p>
                </form>
              </div>
            </div>
