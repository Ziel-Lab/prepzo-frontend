...
export default function Features() {
  ...
  const [filtered, setFiltered] = useState<Integration[]>(integrations);

  useEffect(() => {
    setFiltered(
      integrations.filter((elm: Integration) =>
      ...
      <div className="section-outer panel py-4 md:py-6 xl:py-10">
        <div className="container sm:max-w-lg">
          <div className="section-inner panel">
            ...
            <div className="panel vstack items-center gap-4 md:gap-6 lg:gap-8">
              <ul
              ...
              <div className="products-lisiting flex-none w-100 uc-switcher" role="presentation">
                <div className="uc-active" id="uc-switcher-24" role="tabpanel">
                  <div className="panel">
                          ...
                          <div className="panel overflow-hidden border bg-white dark:bg-gray-900 dark:text-white hover:border-dark hover:contrast-shadow duration-150 hover:-translate-y-1 rounded-1-5">
                            ...
                            <div className="content vstack items-start gap-4 p-2 lg:p-4">
                              <div className="vstack gap-1">
                                ...
                                <p className="fs-6 opacity-60">{item.description}</p>
                              </div>
                              <a
                                href="#"
                            ...
                            <Link href={`/page-features`} className="position-cover" />
                          </div>
                        </div>
                      ))}
                    </div>
