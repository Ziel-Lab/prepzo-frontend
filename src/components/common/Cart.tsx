...
// Define a CartProduct interface that includes the required properties
...
const Cart: React.FC = () => {
  ...
  const removeItem = (id: number): void => {
    setCartProducts((prev) => (prev as CartProduct[]).filter((elm) => elm.id !== id));
  };
        ...
        <div className="mini-cart-content vstack justify-between panel h-100">
          ...
          <div className="mini-cart-listing panel flex-1 my-4 overflow-scroll">
            ...
            <div className="panel vstack gap-3">
              {(cartProducts as CartProduct[]).map((elm, i) => (
                <div key={i}>
                    ...
                    <div className="hstack gap-2">
                      ...
                      <div className="content vstack gap-narrow fs-6">
                        ...
                        <a
                          ...
                          className="remove fs-7 text-dark dark:text-white cursor-pointer"
                        >
                          Remove
                        </a>
                      </div>
